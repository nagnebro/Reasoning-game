...
class SpriteSheetAnimationUnloop(Entity):
    def __init__(self, texture, animations, tileset_size=None, fps=12, model='quad', autoplay=True, **kwargs):
        if tileset_size is None:
            tileset_size = [4, 1]
        kwargs['model'] = model
